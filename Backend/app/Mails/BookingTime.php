...
<body>
    <div class='content'>
        ...
        <div class='block'>
            <span>
                $from_user'v booked the Session at $current_time(UTC Time).
            </span>
        </div>
        <div class='block'>
            <span>
                Student Avatar : <img src='$mentor_avatar' alt='$from_user' style='width:50px; height: 50px; border-radius:25px;'/>
            </span>
        </div>
        <div class='block'>
            <span>
                Student Name : $from_user.
            </span>
        </div>
        <div class='block'>
            <span>
