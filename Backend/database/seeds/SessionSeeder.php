...
class SessionSeeder extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 12, 'user_id' => 2, 'title' => "Polish Lession", 'from' =>"2020-09-08 08:02:06", 'to' => "2020-09-08 08:02:06", 'invited_id' => "1, 2", 'tags_id' => "2, 3", 'status' => 3],
            ['id' => 13, 'user_id' => 1, 'title' => "Polish Lession", 'from' =>"2020-09-08 08:02:06", 'to' => "2020-09-08 08:02:06", 'invited_id' => "1, 2", 'tags_id' => "2, 3", 'status' => 3],
            ['id' => 14, 'user_id' => 2, 'title' => "Polish Lession", 'from' =>"2020-09-08 08:02:06", 'to' => "2020-09-08 08:02:06", 'invited_id' => "1, 2", 'tags_id' => "2, 3", 'status' => 3],
            ['id' => 15, 'user_id' => 3, 'title' => "Mathematics Lession", 'from' =>"2020-09-08 08:02:06", 'to' => "2020-09-08 08:02:06", 'invited_id' => "1, 2", 'tags_id' => "2, 3", 'status' => 1],
        ];
